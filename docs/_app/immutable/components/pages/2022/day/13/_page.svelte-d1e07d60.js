import{S as l,i as m,s as d,w as g,x as h,y as $,K as y,f as x,t as O,z as _}from"../../../../../chunks/index-69c26055.js";import{c as D,a as S}from"../../../../../chunks/stores-9a814c3a.js";import{R as A}from"../../../../../chunks/Runner-973d1dd1.js";function c(n){return JSON.parse(n.trim())}function f(n){return Array.isArray(n)}function I(n,r){return n>r?1:n<r?-1:0}function R(n,r){return n.length<r.length?-1:n.length>r.length?1:0}function p(n,r){const t=f(n),e=f(r);if(!t&&!e)return I(n,r);t&&!e?r=[r]:e&&!t&&(n=[n]);const s=Math.min(n.length,r.length);for(let o=0;o<s;o++){const i=p(n[o],r[o]);if(i!==0)return i}return R(n,r)}function b(n){const r=[];for(let t=0;t<n.length;t++){const e=c(n[t][0]),s=c(n[t][1]);p(e,s)<0&&r.push(t+1)}return r}function u(n){return n.trim()}function w(n){return n=n.split(`

`).map(t=>t.split(`
`)),b(n).reduce((t,e)=>t+e,0)}function M(n){const r="[[2]]",t="[[6]]";let s=(n+`
${r}
${t}`).replace(`

`,`
`).split(`
`).filter(a=>a.length>0).map(a=>c(a));s=s.sort(p).map(a=>JSON.stringify(a));const o=s.indexOf(r)+1,i=s.indexOf(t)+1;return console.log(o,i),o*i}const N=`[[[[]]],[[[1,2,7,3,10],10,8,4,10]],[1,3,[],6,0]]\r
...
\r
[1,[2,[3,[4,[5,6,7]]]],8,9]\r
[1,[2,[3,[4,[5,6,0]]]],8,9]`;function v(n){let r,t;return r=new A({props:{part1:w,part2:M,preprocessor:u,metadata:C}}),{c(){g(r.$$.fragment)},l(e){h(r.$$.fragment,e)},m(e,s){$(r,e,s),t=!0},p:y,i(e){t||(x(r.$$.fragment,e),t=!0)},o(e){O(r.$$.fragment,e),t=!1},d(e){_(r,e)}}}const C={title:"Distress Signal",day:"13",year:"2022",description:"It looks like we just picked up a distress signal, but all of the packets are out of order. We need to unscramble the packets to get the information!",longRuntime:!1,result1:"Sum of indices of correct packets",result2:"Product of indices of distress signals",keywords:["TODO: COMMENT, functional, parsing, sorting, recursion"],visible:!0};function E(n){return D.set(u(N)),S.set(u(k)),[]}class j extends l{constructor(r){super(),m(this,r,E,v,d,{})}}export{j as default,C as myMetadata};
