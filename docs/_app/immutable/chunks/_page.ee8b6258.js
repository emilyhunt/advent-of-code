import{s as p,n as b}from"./scheduler.fd3686c2.js";import{S as k,i as j,k as q,m as z,o as u,p as w,q as a,r as y}from"./index.a4ac66b3.js";import{c as _,a as $}from"./stores.6c700347.js";import{R as D}from"./Runner.2278a328.js";const v="The Trebuchet",h="01",i="2023",o=`There's a trebuchet! We need to decode a code so that the elves can launch us. For Reasons.
This puzzle SUCKED for a day one - the trick in Part 2 was annoying!`,g=!1,x="Calibration number",c="Calibration number",m=["string","replaceAll","search","object"],l=!0,R={title:v,day:h,year:i,description:o,longRuntime:g,result1:x,result2:c,keywords:m,visible:l},S=Object.freeze(Object.defineProperty({__proto__:null,day:h,default:R,description:o,keywords:m,longRuntime:g,result1:x,result2:c,title:v,visible:l,year:i},Symbol.toStringTag,{value:"Module"}));function f(r){return r.trim()}function d(r){return r.split(`
`).map(n=>n.split("").filter(s=>!isNaN(s)).join("")).map(n=>Number(n.slice(0,1)+n.slice(-1))).reduce((n,s)=>n+s,0)}function T(r){const e={one:"o1e",two:"t2o",three:"t3e",four:"f4r",five:"f5e",six:"s6x",seven:"s7n",eight:"e8t",nine:"n9e"};let t=r;for(const n in e)t=t.replaceAll(n,e[n]);return d(t)}const C=`six1mpffbnbnnlxthree
4eight3one92
9nine2xnhvjtjlzj48
...
twonrpvnnmvkh2threejzcpz`,O=`two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
zoneight234
7pqrstsixteen`;function N(r){let e,t;return e=new D({props:{part1:d,part2:T,preprocessor:f,metadata:P}}),{c(){q(e.$$.fragment)},l(n){z(e.$$.fragment,n)},m(n,s){u(e,n,s),t=!0},p:b,i(n){t||(w(e.$$.fragment,n),t=!0)},o(n){a(e.$$.fragment,n),t=!1},d(n){y(e,n)}}}const P=S;function A(r){return _.set(f(C)),$.set(f(O)),[]}class U extends k{constructor(e){super(),j(this,e,A,N,p,{})}}export{U as default,P as myMetadata};
