import{s as w,n as S}from"./scheduler.fd3686c2.js";import{S as R,i as j,k as D,m as N,o as v,p as O,q as P,r as k}from"./index.a4ac66b3.js";import{c as A,a as G}from"./stores.c0fecea1.js";import{R as C}from"./Runner.a060b87f.js";const f="Gear Ratios",$="03",m="2023",h="We need to get to the water source, but our gondola is broken (Part 1) and slow (Part 2). Let's fix it... with code!",d=!1,p="Result",g="Result",y=["classes","for..of","coordinates"],b=!0,E={title:f,day:$,year:m,description:h,longRuntime:d,result1:p,result2:g,keywords:y,visible:b},X=Object.freeze(Object.defineProperty({__proto__:null,day:$,default:E,description:h,keywords:y,longRuntime:d,result1:p,result2:g,title:f,visible:b,year:m},Symbol.toStringTag,{value:"Module"}));function a(t){let n=t.trim().split(`
`);return{data:n,width:n[0].length,height:n.length,maxX:n[0].length-1,maxY:n.length-1}}function x(t){return!isNaN(t)}function u(t){return!x(t)&&t!=="."}function q(t){return t.split("").some(n=>u(n))}function c(t,n,e,r){return q(t.data[n].slice(e,r+1))}class I{constructor(n,e,r){this.number=Number(n),this.x=e,this.y=r,this.length=n.length}appendDigit(n){this.number=Number(String(this.number)+n),this.length+=1}pointIsAdjacent(n){return!(this.y<n.y-1||this.y>n.y+1||this.x-1>n.x||this.x+this.length<n.x)}hasAdjacentSymbol(n){const e=this.x>0?this.x-1:0,r=this.x+this.length<n.maxX?this.x+this.length:this.x+this.length-1;return!!(this.y>0&&c(n,this.y-1,e,r)||this.y<n.maxY&&c(n,this.y+1,e,r)||u(n.data[this.y][e])||u(n.data[this.y][r]))}}class M{constructor(n,e){this.x=n,this.y=e}}function Y(t,n,e,r,s,i){const o=e===s;if(x(t)){if(!n)return new I(t,e,r);if(n.appendDigit(t),!o)return n}n&&i.push(n)}function z(t,n,e,r){n==="*"&&t.push(new M(e,r))}function _(t,n){let e=[],r=[],s;for(let i=0;i<t.height;i++)for(let o=0;o<t.width;o++){const l=t.data[i][o];s=Y(l,s,o,i,t.maxX,e),n&&z(r,l,o,i)}return n?[e,r]:e}function L(t,n){return n.filter(e=>e.hasAdjacentSymbol(t)).reduce((e,r)=>e+r.number,0)}function T(t,n){let e=0;for(const r of t){const s=n.filter(i=>i.pointIsAdjacent(r));s.length==2&&(e+=s[0].number*s[1].number)}return e}function V(t){const n=_(t,!1);return L(t,n)}function W(t){const[n,e]=_(t,!0);return T(e,n)}const B=`.............65..................998.........453...................................845..773.........................307....527...........541
...
..579..410..3..44.291..........................538..................148....873.................461....................................722...`,F=`467..114..
...*......
..35..633.
......#...
617*......
...
......755.
...$.*....
.664.598..`;function H(t){let n,e;return n=new C({props:{part1:V,part2:W,preprocessor:a,metadata:J}}),{c(){D(n.$$.fragment)},l(r){N(n.$$.fragment,r)},m(r,s){v(n,r,s),e=!0},p:S,i(r){e||(O(n.$$.fragment,r),e=!0)},o(r){P(n.$$.fragment,r),e=!1},d(r){k(n,r)}}}const J=X;function K(t){return A.set(a(B)),G.set(a(F)),[]}class t4 extends R{constructor(n){super(),j(this,n,K,H,w,{})}}export{t4 as default,J as myMetadata};
