import{s as f,n as p}from"./scheduler.fd3686c2.js";import{S as w,i as _,k as h,m as D,o as y,p as $,q as k,r as S}from"./index.a4ac66b3.js";import{c as O,a as N}from"./stores.0053c7b4.js";import{R as I}from"./Runner.76c02351.js";const g="Cube Conundrum",a="02",t="2023",m="This puzzle was a close one! All of the talk about pulling red, green, and blue cubes out of a bag had me CONVINCED that this was going to be about binomial probabilities. Flashbacks to high school stats class ensued... thankfully, it wasn't 😅",o=!1,s="Sum of good IDs",G="Sum of game powers",i=["string","array","for..in","for..of","functional"],c=!0,R={title:g,day:a,year:t,description:m,longRuntime:o,result1:s,result2:G,keywords:i,visible:c},v=Object.freeze(Object.defineProperty({__proto__:null,day:a,default:R,description:m,keywords:i,longRuntime:o,result1:s,result2:G,title:g,visible:c,year:t},Symbol.toStringTag,{value:"Module"}));function b(r){const e=r.trim().split(`
`);let u={};for(const n of e){const l=n.split(":");u[Number(l[0].slice(5))]=l[1].split(";").map(d=>d.trim())}return u}function P(r,e){const u=r.split(",").map(n=>n.trim());for(const n of u){const[l,d]=n.split(" ");if(e[d]<Number(l))return!1}return!0}function j(r,e){for(const u of r)if(!P(u,e))return!1;return!0}function x(r,e){let u=0;for(const n in r)j(r[n],e)&&(u+=Number(n));return u}function z(r){return x(r,{red:12,green:13,blue:14})}function T(r,e){const u=r.split(",").map(n=>n.trim());for(const n of u){let[l,d]=n.split(" ");l=Number(l),e[d]<l&&(e[d]=l)}}function q(r){return r.red*r.green*r.blue}function A(r){let e={red:0,green:0,blue:0};for(const u of r)T(u,e);return q(e)}function C(r){let e=0;for(const u in r)e+=A(r[u]);return e}function E(r){return C(r)}const M=`Game 1: 13 green, 3 red; 4 red, 9 green, 4 blue; 9 green, 10 red, 2 blue
...
Game 100: 5 red, 9 green, 2 blue; 9 blue, 6 green, 1 red; 8 blue, 7 green, 3 red`,V=`Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`;function F(r){let e,u;return e=new I({props:{part1:z,part2:E,preprocessor:b,metadata:B}}),{c(){h(e.$$.fragment)},l(n){D(e.$$.fragment,n)},m(n,l){y(e,n,l),u=!0},p,i(n){u||($(e.$$.fragment,n),u=!0)},o(n){k(e.$$.fragment,n),u=!1},d(n){S(e,n)}}}const B=v;function H(r){return O.set(b(M)),N.set(b(V)),[]}class U extends w{constructor(e){super(),_(this,e,H,F,f,{})}}export{U as default,B as myMetadata};
