import{s as w,n as a}from"./scheduler.82952e60.js";import{S as y,i as _,k as $,m as O,o as D,p as N,q as S,r as T}from"./index.2b09750c.js";import{c as C,a as I}from"./stores.7b94593c.js";import{R}from"./Runner.94369487.js";const l="The Trebuchet",d="01",b="2023",p="There's a trebuchet! This puzzle SUCKED for day one. I did not know how to do that more nicely =(",k=!1,j="Calibration number",q="Calibration number",z=["string","regex","search"],u=!0,E={title:l,day:d,year:b,description:p,longRuntime:k,result1:j,result2:q,keywords:z,visible:u},M=Object.freeze(Object.defineProperty({__proto__:null,day:d,default:E,description:p,keywords:z,longRuntime:k,result1:j,result2:q,title:l,visible:u,year:b},Symbol.toStringTag,{value:"Module"}));function m(t){return t.trim().split(`
`)}function P(t){return t.map(n=>n.split("").filter(s=>!isNaN(s)).join("")).map(n=>Number(n.slice(0,1)+n.slice(-1))).reduce((n,s)=>n+s,0)}function x(t,e,r){return r===!0?t.lastIndexOf(e):t.indexOf(e)}function F(t){const e={one:"1",two:"2",three:"3",four:"4",five:"5",six:"6",seven:"7",eight:"8",nine:"9"};let r=0;for(const n of t){let s=1e3,i=-1,o=0,g=0;for(const f of Object.values(e)){const v=x(n,f);v<s&&v!==-1&&(s=v,o=f);const h=x(n,f,!0);h>i&&h!==-1&&(i=h,g=f)}for(const f in e){const v=x(n,f);v<s&&v!==-1&&(s=v,o=e[f]);const h=x(n,f,!0);h>i&&h!==-1&&(i=h,g=e[f])}const c=Number(o+g);console.log(n,o,g,c),r+=c}return r}const K=`six1mpffbnbnnlxthree
4eight3one92
9nine2xnhvjtjlzj48
...
twonrpvnnmvkh2threejzcpz`,U=`two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
zoneight234
7pqrstsixteen`;function A(t){let e,r;return e=new R({props:{part1:P,part2:F,preprocessor:m,metadata:B}}),{c(){$(e.$$.fragment)},l(n){O(e.$$.fragment,n)},m(n,s){D(e,n,s),r=!0},p:a,i(n){r||(N(e.$$.fragment,n),r=!0)},o(n){S(e.$$.fragment,n),r=!1},d(n){T(e,n)}}}const B=M;function G(t){return C.set(m(K)),I.set(m(U)),[]}class V extends y{constructor(e){super(),_(this,e,G,A,w,{})}}export{V as default,B as myMetadata};
